...
sleep 5
/Applications/Firefox.app/Contents/MacOS/firefox-bin -private "http://localhost:3000/index.html?otiluke-alias=client1" -new-tab -url "http://localhost:3000/index.html?otiluke-alias=client2"n